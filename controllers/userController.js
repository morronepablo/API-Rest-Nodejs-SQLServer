...
//     console.log("Resultado de knex.raw:", JSON.stringify(users, null, 2)); // Depuración

//     // Verificar si hay datos en recordset
//     if (users.recordset && users.recordset.length > 0) {
//       res.json(users.recordset);
//     } else if (users.rows && users.rows.length > 0) {
//       // Alternativa para algunas configuraciones de Knex
//       res.json(users.rows);
//     } else {
//       res.status(200).json([]); // Devolver array vacío si no hay usuarios
//     }
//   } catch (error) {
//     console.error("Error al obtener usuarios:", error.message); // Depuración
//     res
//       .status(500)
...
//     // Inspeccionar el resultado completo para depurar
//     console.log(
//       "Resultado completo de knex.raw:",
//       JSON.stringify(result, null, 2)
//     );

//     // Verificar si el resultado contiene los datos del usuario
//     let userData;
//     if (result && result.recordset && result.recordset.length > 0) {
//       userData = result.recordset[0]; // { id, name, email }
...
//   const { name, email, password } = req.body;
//   try {
//     // Validar los datos de entrada (name y email son obligatorios)
//     if (!name || !email) {
...
//     // Verificar si el resultado contiene los datos actualizados
//     let updatedUserData;
//     if (result && result.recordset && result.recordset.length > 0) {
//       updatedUserData = result.recordset[0]; // { id, name, email }
//     } else {
//       // Si el procedimiento no devuelve los datos, los buscamos manualmente
...
//       userData = users.rows;
//     } else {
//       console.log("No se encontraron datos en recordset ni en rows");
//     }

//     res.status(200).json(userData);
//   } catch (error) {
//     console.error("Error al obtener usuarios:", error.message); // Depuración de errores
//     res
//       .status(500)
//       .json({ error: "Error al obtener usuarios", details: error.message });
//   }
